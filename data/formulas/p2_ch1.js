export const formulas_p2_ch1 = [
  {
    ...
    latex:
      "\\frac{T - T_{ice}}{T_{steam} - T_{ice}} = \\frac{X - X_{ice}}{X_{steam} - X_{ice}}",
    variables: [
      { symbol: "T", meaning: "Unknown temperature", unit: "°C / K" },
      {
        symbol: "T_{ice}",
        meaning: "Ice point (Lower Fixed Point)",
        unit: "°C / K",
      },
      {
        symbol: "T_{steam}",
        meaning: "Steam point (Upper Fixed Point)",
        unit: "°C / K",
      },
      {
        symbol: "X",
        meaning: "Thermometric property (Pressure, Resistance, etc.)",
        unit: "varies",
      },
    ],
    ...
    specialCases: [
      {
        condition: "Celsius Scale",
        latex: "\\frac{C}{100} = \\frac{X - X_{0}}{X_{100} - X_{0}}",
      },
    ],
    mcqShortcuts: [
      "X can be Resistance (Rt), Pressure (Pt), or Volume (Vt).",
      "Standard ice point is 0°C and steam point is 100°C.",
    ],
  },
  {
  ...
  },
  {
    ...
    variables: [
      ...
      {
        symbol: "L",
        meaning: "Latent heat (fusion or vaporization)",
        unit: "J/kg",
      },
    ],
    ...
    specialCases: [
      ...
      {
        condition: "Water Vaporization",
        latex: "L_v = 2,260,000 \\text{ J/kg}",
      },
    ],
    mcqShortcuts: [
      "During phase change, temperature remains constant.",
      "Water has highest specific heat (4200 J/kg·K).",
    ],
  ...
  },
  {
    ...
    variables: [{ symbol: "\\gamma", meaning: "Cp/Cv ratio", unit: "N/A" }],
    assumptions: "Ideal gas.",
    specialCases: [
      { condition: "Adiabatic TV", latex: "TV^{\\gamma-1} = \\text{const}" },
      {
        condition: "Adiabatic TP",
        latex: "T^\\gamma P^{1-\\gamma} = \\text{const}",
      },
    ],
    mcqShortcuts: [
      "Adiabatic slope is γ times isothermal slope.",
      "Sudden changes are adiabatic.",
    ],
    hasVisualization: true,
  ...
  },
  {
    ...
    variables: [{ symbol: "S", meaning: "Entropy", unit: "J/K" }],
