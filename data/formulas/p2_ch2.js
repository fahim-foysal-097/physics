export const formulas_p2_ch2 = [
  {
    ...
    variables: [
      ...
      { symbol: "\\epsilon_0", meaning: "Permittivity of free space", unit: "C²/N·m²" },
      { symbol: "K", meaning: "Dielectric Constant (পরাবৈদ্যুতিক ধ্রুবক)", unit: "Unitless" }
    ],
    assumptions: "Charges are point charges and stationary.",
    specialCases: [
      { condition: "\\text{In Vacuum/Air}", latex: "K = 1 \\Rightarrow F = \\frac{1}{4\\pi\\epsilon_0}\\frac{q_1 q_2}{r^2}" },
      { condition: "\\text{Value of } \\frac{1}{4\\pi\\epsilon_0}", latex: "9 \\times 10^9 \\text{ N·m}^2/\\text{C}^2" }
    ],
  ...
  },
  {
    ...
    specialCases: [
      { condition: "\\text{For a Sphere}", latex: "\\sigma = \\frac{q}{4\\pi r^2}" }
    ],
    mcqShortcuts: [
  ...
  },
  {
    ...
    specialCases: [
      { condition: "\\text{Relation with Potential}", latex: "E = -\\frac{dV}{dr}" }
    ],
    hasVisualization: true,
  ...
  },
  {
    ...
    latex: "V = \\frac{1}{4\\pi\\epsilon_0} \\frac{q}{r}, \\quad E = \\frac{1}{4\\pi\\epsilon_0} \\frac{q}{r^2}",
    variables: [
    ...
    specialCases: [
      { condition: "\\text{Outside (} r > R \\text{)}", latex: "E \\propto \\frac{1}{r^2}, V \\propto \\frac{1}{r}" },
      { condition: "\\text{On Surface (} r = R \\text{)}", latex: "E_{max} = \\frac{1}{4\\pi\\epsilon_0} \\frac{q}{R^2}, V_{max} = \\frac{1}{4\\pi\\epsilon_0} \\frac{q}{R}" },
      { condition: "\\text{Inside (} r < R \\text{)}", latex: "E = 0, V = V_{surface} = \\text{Constant}" }
    ],
    hasVisualization: true,
  ...
  },
  {
    ...
    specialCases: [
      { condition: "\\text{Charge (Q)}", latex: "Q_{big} = n \\cdot q_{small}" },
      { condition: "\\text{Capacitance (C)}", latex: "C_{big} = n^{1/3} c_{small}" },
      { condition: "\\text{Potential (V)}", latex: "V_{big} = n^{2/3} v_{small}" },
      { condition: "\\text{Electric Field (E)}", latex: "E_{big} = n^{1/3} e_{small}" },
  ...
  },
  {
    ...
    specialCases: [
      { condition: "\\text{Work done to rotate}", latex: "W = pE(\\cos\\theta_1 - \\cos\\theta_2)" }
    ],
    hasVisualization: true,
  ...
  },
  {
    ...
    specialCases: [
      { condition: "\\text{Stored Energy (U)}", latex: "U = \\frac{1}{2}CV^2 = \\frac{Q^2}{2C} = \\frac{1}{2}QV" }
    ],
    hasVisualization: true,
    vizType: "capacitor",
    mcqShortcuts: [
  ...
  },
  {
    ...
    nameBn: "ধারকের সমবায়",
    latex: "C_p = C_1 + C_2 + \\dots \\newline \\frac{1}{C_s} = \\frac{1}{C_1} + \\frac{1}{C_2} + \\dots",
    variables: [
      { symbol: "C_p", meaning: "Equivalent Capacitance (Parallel)", unit: "F" },
      { symbol: "C_s", meaning: "Equivalent Capacitance (Series)", unit: "F" }
    ],
    assumptions: "",
    specialCases: [
      { condition: "\\text{In Series}", latex: "\\text{Charge (Q) is same for all.}" },
      { condition: "\\text{In Parallel}", latex: "\\text{Potential Difference (V) is same.}" }
    ]
  },
  {
    id: "gauss_law",
    ...
    nameEn: "Gauss's Law",
    nameBn: "গাউসের সূত্র",
    latex: "\\phi = \\oint \\vec{E} \\cdot d\\vec{A} = \\frac{\\Sigma q}{\\epsilon_0}",
    variables: [
    ...
    specialCases: [
      { condition: "\\text{Infinite Charged Sheet}", latex: "E = \\frac{\\sigma}{2\\epsilon_0}" },
      { condition: "\\text{Infinite Charged Wire}", latex: "E = \\frac{\\lambda}{2\\pi\\epsilon_0 r}" }
    ]
  }
];
