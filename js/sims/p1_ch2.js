  ...
  draw: (sketch, vizType) => {
    ...
    switch (vizType) {
      case "vector_addition": {
        ...
        let res = sketch.sqrt(pVal*pVal + qVal*qVal + 2*pVal*qVal*sketch.cos(theta));
        sketch.fill("#4f46e5");
      ...
      case "river_boat": {
        ...
        sketch.rect(0, riverBottomY, sketch.width, sketch.height - riverBottomY);
        ...
        let heading = sketch.animating ? sketch.atan2(-curV * sketch.sin(curAlpha), curV * sketch.cos(curAlpha) + curU) : -curAlpha;
        ...
        let calculatedDrift = (curV * sketch.cos(curAlpha) + curU) * calculatedTime;
      ...
      case "rain_umbrella": {
        ...
        let statusTitle = isProtected ? "Umbrella Aligned (Protected! ✅)" : "Getting Wet! (Adjust Umbrella ❌)";
